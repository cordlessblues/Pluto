...
match platform.system():
    case "Windows":
        ...
        FilePath = os.getcwd()
    case "Linux":
        # i love linux and its .config dir
        ...
        os.chdir(ParentPath)
        #print(homePath+ConfigDir+FileName)
    case _:
        print('Error Cannot recognize OS, defaulting to linux. ("what is this foreign land")')
...
class MainApp(QWidget):
    ...
    def AboutMenu(self):
        ...
        print(QSystemTrayIcon.supportsMessages())
